...
<head>
    ...
    <title>Edit Appointment | Administration System Qualiteeth Dental Clinic | Sistem Pentadbiran Klinik Pergigian Qualiteeth</title> 
...
<div class="border-container">
    <div class="form_wrapper">
        <div class="backSearch">
			<a class="arrow" href="A_AppointmentList.php">
				<div class="al">
        ...
        <section class="apBox">
            <div class="apppple">
                <form class = "formBox" id="App_Form" action="./A_Functions/db_editAppointmentHistory.php" method="post">
                    <legend>
                    <h1 class="h1NA">Edit Appointment' Details</h1>
                        <h3 class="h3NA">Change your appointment details here.</h3>
                    </legend>
                    <section class="oldDetails">
                <ul class="admin-details" id="App_details">
                    <?php 
                            ...
                            <select id="doctorSelect" name="doc_name" required>
                                ...
                                foreach ($data_rows as $row) {
                                    ...
                                    <option value="<?php echo $doctorName; ?>"
                                        <?php if ($app_doc == $doctorName) { echo "selected"; } ?>>
                                        <?php echo $doctorName; ?>
                                    </option>
                                <?php } ?>
                            </select>
