<script>
	var redirectURL = '../A_CustomersList.php';
</script>
<?php
...
if (isset($_POST['signup'])) {
    ...
    $fileDestination = '../../../User/Images/user.png';
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        echo '<script>
            alert("The email entered already exists, please try checking the email in system . . . ")
            </script>';
        header("Refresh: 0; url= ../A_AddCustomers.php"); 
        exit();
    } else {
        ...
        if (mysqli_query($conn, $query)) {
            echo '<script>
                alert("Successfully added customer into system . . . ")
